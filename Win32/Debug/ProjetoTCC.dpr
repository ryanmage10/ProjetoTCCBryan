...
uses
  ...
  uCondicaoPagamentoController in 'uCondicaoPagamentoController.pas',
  ...
  uParcelaModelos in 'uParcelaModelos.pas',
  ...
  uItensCompra in 'uItensCompra.pas',
  uComprasController in 'uComprasController.pas',
  uComprasService in 'uComprasService.pas',
  uComprasFactory in 'uComprasFactory.pas',
  uComprasDao in 'uComprasDao.pas';
