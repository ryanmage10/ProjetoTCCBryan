...
uses
  ...
  cxButtons, cxTextEdit, dxLayoutContainer, cxClasses, dxLayoutControl,
...
type
  TCons_Base = class(TForm)
    ...
    btn_Sair: TcxButton;
    LayoutSelecao: TdxLayoutItem;
    btn_Selecionar: TcxButton;
